...
const DOMCollection = prettyFormat__namespace.plugins.DOMCollection;
...
function createEvent(eventName, node, init, _temp) {
  ...
  const _eventInit$target = eventInit.target,
    ...
    targetProperties = _objectWithoutPropertiesLoose__default["default"](_eventInit$target2, _excluded);
  if (value !== undefined) {
