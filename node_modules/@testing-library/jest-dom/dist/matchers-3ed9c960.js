...
function createQueryMatcher(quantity, queryName) {
  ...
  const query = dom.queries[`queryAllBy${strategy}`];
    ...
    return {
      message: () => {
        ...
        const prettyElements = elements
          .map(element => dom.prettyDOM(element))
          .filter(isString);
...
exports.toContainAnyByAltText = toContainAnyByAltText;
exports.toContainAnyByDisplayValue = toContainAnyByDisplayValue;
exports.toContainAnyByLabelText = toContainAnyByLabelText;
exports.toContainAnyByPlaceholderText = toContainAnyByPlaceholderText;
exports.toContainAnyByRole = toContainAnyByRole;
exports.toContainAnyByTestId = toContainAnyByTestId;
exports.toContainAnyByText = toContainAnyByText;
exports.toContainAnyByTitle = toContainAnyByTitle;
exports.toContainElement = toContainElement;
exports.toContainHTML = toContainHTML;
exports.toContainOneByAltText = toContainOneByAltText;
exports.toContainOneByDisplayValue = toContainOneByDisplayValue;
exports.toContainOneByLabelText = toContainOneByLabelText;
exports.toContainOneByPlaceholderText = toContainOneByPlaceholderText;
exports.toContainOneByRole = toContainOneByRole;
exports.toContainOneByTestId = toContainOneByTestId;
exports.toContainOneByText = toContainOneByText;
exports.toContainOneByTitle = toContainOneByTitle;
