...
const queryMatchers = queryNames.reduce((matchers, queryName) => {
...
var extensions = /*#__PURE__*/Object.freeze({
  ...
  toContainAnyByAltText: toContainAnyByAltText,
  toContainAnyByDisplayValue: toContainAnyByDisplayValue,
  toContainAnyByLabelText: toContainAnyByLabelText,
  toContainAnyByPlaceholderText: toContainAnyByPlaceholderText,
  toContainAnyByRole: toContainAnyByRole,
  toContainAnyByTestId: toContainAnyByTestId,
  toContainAnyByText: toContainAnyByText,
  toContainAnyByTitle: toContainAnyByTitle,
  toContainElement: toContainElement,
  toContainHTML: toContainHTML,
  toContainOneByAltText: toContainOneByAltText,
  toContainOneByDisplayValue: toContainOneByDisplayValue,
  toContainOneByLabelText: toContainOneByLabelText,
  toContainOneByPlaceholderText: toContainOneByPlaceholderText,
  toContainOneByRole: toContainOneByRole,
  toContainOneByTestId: toContainOneByTestId,
  toContainOneByText: toContainOneByText,
  toContainOneByTitle: toContainOneByTitle,
...
export { toHaveRole as A, toHaveAccessibleName as B, toHaveAttribute as C, toHaveClass as D, toHaveStyle as E, toHaveFocus as F, toHaveFormValues as G, toBeVisible as H, toBeDisabled as I, toBeEnabled as J, toBeRequired as K, toBeInvalid as L, toBeValid as M, toHaveValue as N, toHaveDisplayValue as O, toBeChecked as P, toBePartiallyChecked as Q, toHaveDescription as R, toHaveErrorMessage as S, toHaveSelection as T, toBePressed as U, toBePartiallyPressed as V, toAppearBefore as W, toAppearAfter as X, toContainOneByAltText as a, toContainAnyByDisplayValue as b, toContainOneByDisplayValue as c, toContainAnyByLabelText as d, extensions as e, toContainOneByLabelText as f, toContainAnyByPlaceholderText as g, toContainOneByPlaceholderText as h, toContainAnyByRole as i, toContainOneByRole as j, toContainAnyByTestId as k, toContainOneByTestId as l, toContainAnyByText as m, toContainOneByText as n, toContainAnyByTitle as o, toContainOneByTitle as p, toBeInTheDOM as q, toBeInTheDocument as r, toBeEmpty as s, toContainAnyByAltText as t, toBeEmptyDOMElement as u, toContainElement as v, toContainHTML as w, toHaveTextContent as x, toHaveAccessibleDescription as y, toHaveAccessibleErrorMessage as z };
