...
export declare function loadFile<Exports extends object = any>(filename: string, options?: Options): Promise<ProxifiedModule<Exports>>;
export declare function writeFile(node: {
  $ast: ASTNode;
