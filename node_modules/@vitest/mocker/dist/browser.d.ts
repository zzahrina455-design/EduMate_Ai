import { M as ModuleMockerInterceptor } from './mocker.d-CMHJLkLP.js';
export { C as CompilerHintsOptions, b as ModuleMocker, a as ModuleMockerCompilerHints, c as ModuleMockerConfig, d as ModuleMockerRPC, R as ResolveIdResult, e as ResolveMockResult, f as createCompilerHints } from './mocker.d-CMHJLkLP.js';
import { StartOptions, SetupWorker } from 'msw/browser';
import { MockerRegistry, MockedModule } from './index.js';
import '@vitest/spy';
