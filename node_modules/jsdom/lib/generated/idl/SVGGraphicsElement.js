...
const $interfaceDescriptor = utils.createInterfaceDescriptor(() => SVGElement.interfaceDescriptor);
  ...
  class SVGGraphicsElement extends globalObject.SVGElement {
    ...
    get requiredExtensions() {
      ...
      return utils.getSameObject(this, "requiredExtensions", () => {
        return utils.tryWrapperForImpl($impl["requiredExtensions"]);
      });
    }
    ...
    get systemLanguage() {
      ...
      return utils.getSameObject(this, "systemLanguage", () => {
        return utils.tryWrapperForImpl($impl["systemLanguage"]);
      });
    }
  }
